#!/usr/bin/env python3
"""
🟡 PS2TRADEB v4.0 - Simplified Binance Trading Bot
Direct REST API
"""
...
def get_price(symbol):
    try:
        ...
        logger.warning(f"⚠️ Price error for {symbol}: {e}")
        return None
...
def generate_signal(symbol):
    try:
        ...
        # Multi-factor signal: Change + RSI + Volume
        # BUY: Positive momentum + Oversold RSI
        ...
        # SELL: Negative momentum + Overbought RSI
...
def main():
    ...
    while True:
        ...
        try:
            ...
            if signals:
                msg = f"🟡 PS2TRADEB v4 - {len(signals)} signals\n"
                for s in signals[:5]:
